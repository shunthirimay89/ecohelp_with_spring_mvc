...
<div class="signup-form">
    <form:form action="/EcoHelp/createUser" method="post" modelAttribute="user_info">
		<h2>Add Form</h2>
		<p>Create User</p>
		<hr>
        ...
        <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = 'displayuser';">
                Back
            </button>
    </form:form>
