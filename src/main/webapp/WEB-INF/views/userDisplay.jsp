...
th {
	width: 20%; /* Set the width for each header column */
}
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-success"
										onclick="location.href='historyDonated/${user.id}'">
										View</button>
								</td>

								<td><c:if test="${!user.locked }">
										<button type="button" class="btn btn-dark button"
											onclick="confirmBan('${user.id}')">Unban</button>
									</c:if> <c:if test="${user.locked }">
										<button type="button" class="btn btn-danger button"
											onclick="confirmBan('${user.id}')">Ban</button>
									</c:if>
									</td>
							</tr>
						</c:forEach>
...
<script>
	...
	function confirmBan(userId) {
        ...
        if (confirmation) {
            ...
            window.location.href = 'banUser/' + userId;
        } else {
