...
<div id="imageerror" style="color:red;">${imageerror}</div>
    <form:form action="/EcoHelp/createplace" method="post" modelAttribute="donate_info" enctype="multipart/form-data">
		<h2>Add Place</h2>
		<p>Add New Place</p>
		<hr>
		<%-- <div class="form-group">
			<div class="input-group">
				...
				<form:input type="id" class="form-control"  path="id" placeholder="Id" required="required"/>
			</div>
        </div> --%>
        <div class="form-group">
			<div class="input-group">
				...
				<form:input type="text" class="form-control"  path="name" placeholder="PlaceName" required="required"/>
			</div>
        </div>
        <div class="form-group">
			<div class="input-group">
        ...
        <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = 'displayplace';">
                Back
            </button>
    </form:form>
